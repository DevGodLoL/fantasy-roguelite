                    ...
                    <>
                        ...
                        <section className="space-y-4">
                            <div className="flex items-center gap-4">
                                ...
                                <h2 className="text-xs font-black uppercase tracking-[0.3em] text-amber-400">
                                    Enchanted Artifacts
                                </h2>
                                <div className="h-px flex-1 bg-gradient-to-r from-amber-500/30 to-transparent" />
                                <Link
                                    href={`/league/${leagueId}/inventory`}
                                    className="text-[10px] font-black uppercase tracking-widest text-zinc-500 hover:text-amber-400 transition-colors"
                                >
                                    View Armory →
                                </Link>
                            </div>
