                                ...
                                <React.Fragment key={team.id}>
                                    ...
                                    {index === 5 && (
                                        <tr key="playoff-cutoff">
                                            <td colSpan={5} className="py-2 relative">
                                                <div className="absolute inset-0 flex items-center justify-center">
                                                    <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-purple-500/50 to-transparent" />
                                                </div>
                                                <div className="relative flex justify-center">
                                                    <div className="px-4 py-0.5 bg-black border border-purple-500/30 rounded-full shadow-[0_0_15px_rgba(168,85,247,0.2)]">
                                                        <span className="text-[9px] font-black text-purple-400 uppercase tracking-[.3em]">
                                                            Playoff Cutoff
                                                        </span>
                                                    </div>
                                                </div>
