...
INSERT INTO "new_Team" ("createdAt", "faabBalance", "gold", "id", "leagueId", "name", "nextSeasonBonusGold", "nextSeasonBonusRerolls", "ownerId", "playoffSeed", "rerolls", "updatedAt", "waiverPriority") SELECT "createdAt", "faabBalance", "gold", "id", "leagueId", "name", "nextSeasonBonusGold", "nextSeasonBonusRerolls", "ownerId", "playoffSeed", "rerolls", "updatedAt", "waiverPriority" FROM "Team";
DROP TABLE "Team";
...
CREATE TABLE "new_User" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    "commanderLevel" INTEGER NOT NULL DEFAULT 1,
