...
INSERT INTO "new_Team" ("createdAt", "faabBalance", "gold", "id", "leagueId", "name", "ownerId", "updatedAt", "waiverPriority") SELECT "createdAt", "faabBalance", "gold", "id", "leagueId", "name", "ownerId", "updatedAt", "waiverPriority" FROM "Team";
DROP TABLE "Team";
