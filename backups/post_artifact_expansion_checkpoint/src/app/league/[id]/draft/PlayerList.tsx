...
export default function PlayerList({ players, canDraft, onDraft, leagueId }: PlayerListProps) {
    ...
    return (
        <aside className="w-full lg:w-[300px] h-full border-r border-white/10 flex flex-col bg-black/40 backdrop-blur-sm shrink-0 overflow-hidden">
            {/* Header */}
                    ...
                    return (
                        ...
                        >
                            ...
                            {canDraft ? (
                                ...
                                <span className="opacity-0 group-hover:opacity-50 text-[9px] font-bold text-zinc-600 uppercase tracking-wider px-2">
                                    Wait
                                </span>
                            )}
                        </div>
