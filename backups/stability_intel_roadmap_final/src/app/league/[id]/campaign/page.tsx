...
export default async function CampaignPage({
    ...
    const weeks = league.weeks.map(w => {
        ...
        const userMatchup = weekMatchups.find(m => m.homeTeamId === userTeam.id || m.awayTeamId === userTeam.id);
        const opponent = userMatchup ? (userMatchup.homeTeamId === userTeam.id ? userMatchup.awayTeam : userMatchup.homeTeam) : null;
        ...
        return {
            ...
            matchup: userMatchup ? {
                id: userMatchup.id,
                status: userMatchup.status,
                homeScore: userMatchup.homeScore,
                awayScore: userMatchup.awayScore,
                opponent: opponent ? {
                    name: opponent.name,
